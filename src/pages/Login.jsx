                ...
                <div className="w-[500px] bg-white rounded-md h-[600px]">
                    <div className="h-full w-full flex items-center justify-center flex-col">
                        ...
                        <form className="w-full flex flex-col gap-4 p-6" onSubmit={form.handleSubmit(handleLogin)}>
                            ...
                            <input {...form.register("user")} type="text" placeholder="Digite o usuário..." className="w-full px-3 py-4 border-b-2 border-gray-600 rounded-sm focus:outline-none focus:ring-1 focus:border-none focus:ring-black placeholder-gray-400" />
                            <label className="text-gray-600 text-xl -mb-3 font-bold">Senha:</label>
                            <input {...form.register("password")} type="password" placeholder="Digite a senha..." className="w-full px-3 py-4 border-b-2 border-gray-600  rounded-sm focus:outline-none focus:ring-1 focus:border-none focus:ring-black placeholder-gray-400" />
